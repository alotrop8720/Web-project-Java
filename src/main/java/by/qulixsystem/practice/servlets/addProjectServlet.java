...
public class addProjectServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        project.setTitle(request.getParameter("title_project"));
        project.setAbbreviate(request.getParameter("abbreviated"));
        project.setInformation(request.getParameter("information"));
        ProjectDataBaseDAO projectDataBaseDAO = new ProjectDataBaseDAO(DataBaseConfiguration.getInstance());
        projectDataBaseDAO.createData(project);
